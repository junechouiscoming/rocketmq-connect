 ...
 */
public interface AllocateTaskStrategy {

    /**
     * Allocate tasks to current worker
     *
     ...
     * @return
     */
    AllocateResultConfigs allocate(List<String> allWorker, String curWorker, Map<String, List<ConnectKeyValue>> taskConfigs);
}
